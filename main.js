...
(function() {
  var FiftyCent, all, awardMedals, bad, city, contenders, copy, countdown, drink, drinks, end, error, fizz_buzz, gold, good, grade, gucci, inner, j, k, len, middle, name, num, numbers, numbers1, oldest, one, outer, output, ref, ref1, rest, silver, six, sportsTeams, start, swag, three, title, two, ufo,
    slice = [].slice;
